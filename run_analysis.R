...
#Get activity labels
activity_labels <- read.table("C:\\Users\\10012219\\Downloads\\Week 4 Project Assignment\\UCI HAR Dataset\\activity_labels.txt")
activity_labels <- rename(activity_labels, activityID = V1, activitylabels = V2)

#Get features
features <- read.table("C:\\Users\\10012219\\Downloads\\Week 4 Project Assignment\\UCI HAR Dataset\\features.txt")
features <- rename(features, featureID = V1, featurename = V2)

#Get Test Data (X_test)
X_test <- read.table("C:\\Users\\10012219\\Downloads\\Week 4 Project Assignment\\UCI HAR Dataset\\test\\X_test.txt")
colnames(X_test) <- features[,2]

#Get Test Data (Y_test)
Y_test <- read.table("C:\\Users\\10012219\\Downloads\\Week 4 Project Assignment\\UCI HAR Dataset\\test\\Y_test.txt")
Y_test <- rename(Y_test, activityID = V1)

#Get Test Data (Subject_Test)
subject_test <- read.table("C:\\Users\\10012219\\Downloads\\Week 4 Project Assignment\\UCI HAR Dataset\\test\\subject_test.txt")
...
#Get Train Data (X_train)
X_train <- read.table("C:\\Users\\10012219\\Downloads\\Week 4 Project Assignment\\UCI HAR Dataset\\train\\X_train.txt")
colnames(X_train) <- features[,2]

#Get Test Data (Y_test)
Y_train <- read.table("C:\\Users\\10012219\\Downloads\\Week 4 Project Assignment\\UCI HAR Dataset\\train\\Y_train.txt")
Y_train <- rename(Y_train, activityID = V1)

#Get Test Data (Subject_Test)
subject_train <- read.table("C:\\Users\\10012219\\Downloads\\Week 4 Project Assignment\\UCI HAR Dataset\\train\\subject_train.txt")
